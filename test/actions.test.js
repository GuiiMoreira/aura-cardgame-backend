...
function criarEstadoBase() {
    return {
        jogadores: {
            j1: { vida: 100, recursos: { C: 10, M: 5, O: 5, A: 0 }, recursosMax: { C: 20, M: 20, O: 20, A: 10 }, geracaoRecursos: { C: 3, M: 2, O: 1, A: 1 }, mao: [], baralho: [], cemiterio: [] },
            j2: { vida: 100, recursos: { C: 10, M: 10, O: 10, A: 0 }, recursosMax: { C: 12, M: 12, O: 12, A: 5 }, geracaoRecursos: { C: 5, M: 5, O: 5, A: 2 }, mao: [], baralho: [], cemiterio: [] }
        },
        turno: 'j1',
        campo: { j1: [], j2: [] }
    };
